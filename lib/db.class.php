...
class DB{
    ...
    public function __construct($c = array('port'=>3306, 'host'=>'localhost', 'username'=>'root', 'password'=>'123456', 'dbname'=>'chinavec', 'charset'=>'utf8', 'time_zone'=>'+08:00')){
        ...
        if($c['time_zone']){
            mysql_query("SET GLOBAL TIME_ZONE=" . $c['time_zone'], $this->conn);
        }
    }
	...
	*/
     ...
     */
    function select_condition($table, $condition='1', $connector='AND', $record_type='object'){
     ...
     * @param string $record_type 返回数据类型 默认object
     */
    function select_condition_one($table, $condition='1', $connector='AND', $record_type='object'){
	 ...
	 * @param string connector 连接符
     */
    function delete($table, $condition, $connector='AND'){
